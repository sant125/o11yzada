...
Essa propriedade não é só curiosidade de tipo — o [srezada Cap 5 (Alerting on SLOs)](../srezada/05-alerting-on-slos.md) constrói o **burn rate** (a métrica que dirige alerta de SLO) em cima de `rate()` de um Counter de erro; a garantia de monotonicidade aqui embaixo é literalmente o que sustenta o cálculo de SLO lá em cima.
